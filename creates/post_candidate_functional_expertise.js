...
const perform = async (z, bundle) => {
    const request = {
      url: 'https://{{bundle.authData.subdomain}}/api/v2/candidate/{{bundle.inputData.id}}/functionalexpertises/subfunctionalexpertises',
      method: 'PUT',
  ...
  module.exports = {
    key: 'new_candidate_functional',
    noun: 'Function',
    display: {
      label: 'New Candidate Functional Expertises',
      description: 'Set all licenses and qualifications for a candidate',
    },
    operation: {
      inputFields: [
